...
namespace Exercicio01_Aula07
{
    public class Aluno
    {
        ...
        public Aluno()
        {
            ...
            var imprimirAlunos = ListarAluno(listaAluno);
            var consultarAlunos = ConsultaAluno(listaAluno);
        ...
        public string ListarAluno(List<string> listaAluno)
        {
            Console.WriteLine("--- Imprime Alunos ---");
        ...
        public bool ConsultaAluno(List<string> listaAluno)
        {

            Console.WriteLine("Insira a matrícula do aluno: ");
            matricula = int.Parse(Console.ReadLine());

            foreach (var n in listaAluno)
            {
                if (n.Contains(Convert.ToString(matricula)))
                {
                    Console.WriteLine(n);
                }
            }
